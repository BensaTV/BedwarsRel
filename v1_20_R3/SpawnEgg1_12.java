...
public class SpawnEgg1_12 {
  ...
  public static SpawnEgg1_12 fromItemStack(ItemStack item) {
    ...
    net.minecraft.world.item.ItemStack tagCompound = stack.c();
    if (tagCompound != null) {
      @SuppressWarnings("deprecation")
      EntityType type = EntityType.fromName(tagCompound.b("EntityTag").l("id"));
      if (type != null) {
  ...
  public ItemStack toItemStack(int amount) {
    ...
    net.minecraft.world.item.ItemStack stack = CraftItemStack.asNMSCopy(item);
    NBTTagCompound tagCompound = stack.v();
    if (tagCompound == null) {
      tagCompound = new NBTTagCompound();
    }
    NBTTagCompound id = new NBTTagCompound();
    id.a("id", type.getName());
    tagCompound.a("EntityTag", id);
    stack.c(tagCompound);
